...
*    -------------
*    Utility class for access to runtime permissions. (from google)
*
*/
...
public abstract class PermissionUtils {
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (mFinishActivity) {
                Toast.makeText(getActivity(), R.string.msg_need_permission_contacts,
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (mFinishActivity) {
                Toast.makeText(getActivity(),
                        R.string.msg_need_permission_location,
                        Toast.LENGTH_SHORT)
                        .show();
                getActivity().finish();
            }
