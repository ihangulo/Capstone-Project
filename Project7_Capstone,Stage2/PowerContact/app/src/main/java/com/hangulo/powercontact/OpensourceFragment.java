...
*
*
*     OpenSourceFragment.java
*    -------------
*    Show open source licesne
*
 ...
 * https://github.com/adamsp/AndroidLicensesPage
 * Usage : LicensesFragment.displayLicensesFragment(getSupportFragmentManager());
 */
/**
 ...
 */
public class OpensourceFragment extends DialogFragment {

    final String LOG_TAG= OpensourceFragment.class.getSimpleName(); // error processing

    private AsyncTask<Void, Void, String> mLicenseLoader;

    private static final String FRAGMENT_TAG = ".LicensesFragment";
     ...
     * @return A new licenses fragment.
     */
    public static OpensourceFragment newInstance(boolean showCloseButton) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View content = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_opensources, null);
        ...
        builder.setTitle(R.string.title_opensources);
