...
*   date : Apr. 4th 2016
*
*    PowerContactWidgetProvider.java
*    -------------
*
*
*/
 ...
 *
 * Delegates widget updating to {@link PowerContactWidgetIntentService} to ensure that
 * data retrieval is done on a background thread
 */
public class PowerContactWidgetProvider extends AppWidgetProvider {

    @Override
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        context.startService(new Intent(context, PowerContactWidgetIntentService.class));
    }
